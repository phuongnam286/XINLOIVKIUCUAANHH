...
<body>
  <div class="page">
    <div class="header">
      <h1>ANH XIN LỖI VK IUUUUUU</h1>
      <div class="sub">iUUUU BX NHIỀU LẮMMMM LẮMMMMM</div>
    </div>
    ...
    <div class="stage">
      <div class="heart-wrap">
        <div class="heart" id="heart">
          ...
          <div class="heart-text" id="heartText" contenteditable="true" aria-label="Lời nhắn">Anh yêu em</div>
        </div>
      </div>

      <div class="controls">
        <label for="msg">Lời nhắn</label>
        <textarea id="msg">A BIẾT LỖI R BX OIIIII. BX BỎ QUA CHO ANH NHAA. E MUỐN GÌ A CX CHO HẾT Ă. NGOAN NHAA BX. BX ĐỪNG CÓ GHÉT ANH NHAAA. MÚN IU BX QUÀI LUÔNN 💗 💗 💗💏💏💏💋💋💋🫶🫶🫶❤️❤️❤️💞💞💞 </textarea>
        <div class="buttons">
          <button class="btn" id="updateBtn">NHẤN VÀO ĐÂY NÈ BÉ EM</button>
          <button class="btn secondary" id="resetBtn">ĐẶT LẠI NÈ</button>
        </div>
        <div class="hint">Gõ nội dung và nhấn "NHẤN VÀO ĐÂY NÈ BÉ EM
            "; hoặc chỉnh trực tiếp trên trái tim.</div>
      </div>
    </div>
  </div>
  ...
  <script>
    (function(){
      ...
      updateBtn.addEventListener('click', ()=> setHeart(msg.value.trim() || 'Anh yêu em'));
      resetBtn.addEventListener('click', ()=> setHeart('Anh yêu em'));
